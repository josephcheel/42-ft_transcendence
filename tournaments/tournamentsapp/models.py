...
if settings.DEBUG:
	...
	class User(AbstractUser):
		...
		groups = models.ManyToManyField('auth.Group',related_name='users_db_Group', blank=True)
		user_permissions = models.ManyToManyField('auth.Permission',related_name='users_db_Permission', blank=True)	
...
class Tournaments(models.Model):
	...
	player_id = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True, related_name='tournaments_player')
...
class Invitations(models.Model):
	...
	player_id = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name='invitations_player')
